defmodule VbvWeb.UserLive.Registration do
  use VbvWeb, :live_view

  alias Vbv.Users
  alias Vbv.Users.User

  @impl true
  def render(assigns) do
    ~H"""
    <Layouts.app flash={@flash} current_scope={@current_scope} conn={@conn}>
  ...
  def mount(_params, _session, %{assigns: %{current_scope: %{user: user}}} = socket)
    ...
    {:ok, redirect(socket, to: VbvWeb.UserAuth.signed_in_path(socket))}
  end
